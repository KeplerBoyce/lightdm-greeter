...
export default function mock() {
    if (typeof window.lightdm == 'undefined') {
        ...
        lightdm.sessions = [
            { key: 'i3', name: 'i3', comment: 'no comment' },
            ...
            { key: 'enlightenment', name: 'enlightenment', comment: 'no comment' },
            { key: 'lxqd', name: 'lxqt', comment: 'no comment' }
        ];
